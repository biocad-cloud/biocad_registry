...
CREATE TABLE IF NOT EXISTS `genomics` (
  ...
  `db_xref` VARCHAR(45) COLLATE 'utf8mb3_bin' NULL DEFAULT NULL COMMENT 'ncbi genbank accession id of current genomics sequence',
...
ENGINE = InnoDB
COMMENT = 'genome nucleotide sequence data';
...
CREATE TABLE IF NOT EXISTS `kinetic_law` (
  ...
  `lambda` MEDIUMTEXT CHARACTER SET 'utf8mb3' NOT NULL COMMENT 'the lambda expression of the kinetics',
  ...
  `buffer` MEDIUMTEXT COLLATE 'utf8mb3_bin' NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `ncbi_taxonomy` (
  ...
  `childs` JSON NULL DEFAULT NULL COMMENT 'tax id of the direct child nodes, json array',
...
ENGINE = InnoDB
COMMENT = 'the ncbi taxonomy information';
...
CREATE TABLE IF NOT EXISTS `odor` (
  ...
  `odor` VARCHAR(255) COLLATE 'utf8mb3_bin' NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `pathway` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `xref_id` VARCHAR(45) COLLATE 'utf8mb3_bin' NULL DEFAULT NULL COMMENT 'the external reference id of the pathway',
