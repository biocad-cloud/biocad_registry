...
) ENGINE=InnoDB AUTO_INCREMENT=39179 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin;
...
--
-- Table structure for table `conserved_cluster`
--
...
) ENGINE=InnoDB AUTO_INCREMENT=584703 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=24998147 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `kinetic_substrate`
--
...
) ENGINE=InnoDB AUTO_INCREMENT=28554 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `mesh_link`
--
...
) ENGINE=InnoDB AUTO_INCREMENT=21739426 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=3092570 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=12363234 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin COMMENT='keywords, tags, labels of the molecule entity';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `motif` (
  ...
  `family` varchar(45) COLLATE utf8mb3_bin NOT NULL DEFAULT 'Other',
  `motif` varchar(255) COLLATE utf8mb3_bin NOT NULL,
  `tax_id` int unsigned NOT NULL DEFAULT '0' COMMENT 'should be the ncbi taxonomy id',
  `pwm` longtext COLLATE utf8mb3_bin NOT NULL,
  `add_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin COMMENT='sequence motif feature data';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ontology` (
  ...
  `rank` int unsigned NOT NULL,
  `name` mediumtext CHARACTER SET utf8mb3 COLLATE utf8mb3_bin COMMENT 'the display name of this ontology',
  `add_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `description` longtext COLLATE utf8mb3_bin,
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`),
  KEY `find_term` (`db_xref`,`db_source`),
  FULLTEXT KEY `search_text` (`name`,`description`)
) ENGINE=InnoDB AUTO_INCREMENT=377149 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin COMMENT='molecule ontology class';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=528129 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pathway` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`),
  UNIQUE KEY `name_UNIQUE` (`source_dbkey`,`xref_id`),
...
CREATE TABLE `pathway_graph` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`),
  UNIQUE KEY `uniqque_link` (`pathway_id`,`entity_id`),
...
--
-- Table structure for table `pubmed_source`
--
...
CREATE TABLE `pubmed_source` (
  ...
  KEY `pubmed_data_idx` (`pubmed_id`),
  KEY `molecule_data_idx` (`molecule_id`)
) ENGINE=InnoDB AUTO_INCREMENT=6264551 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `reaction` (
  ...
  FULLTEXT KEY `search_text` (`name`,`note`),
  FULLTEXT KEY `search_all_text` (`name`,`equation`,`note`)
...
CREATE TABLE `regulation_graph` (
  ...
  `reaction_id` int unsigned NOT NULL COMMENT 'the id reference to the reaction table if the term is an ec number or the conserved cluster id if the term is a motif unique id',
  `add_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `note` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_bin,
  PRIMARY KEY (`id`,`term`),
  UNIQUE KEY `id_UNIQUE` (`id`) /*!80000 INVISIBLE */,
...
) ENGINE=InnoDB AUTO_INCREMENT=73464 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin COMMENT='the regulation graph for the enzyme associates with the reactions and TFBS binding site motif associated with the operon cluster';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=11941958 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='synonym names of the biocad registry object, example as: molecules, genomes, taxonomys, reactions, pathways';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `taxonomy_source`
--
...
CREATE TABLE `taxonomy_source` (
  ...
  KEY `uniq_ref` (`molecule_id`,`ncbi_taxid`,`doi`)
) ENGINE=InnoDB AUTO_INCREMENT=2193832 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=2688363 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=15033 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='vocabulary term of the entity in registry database';
/*!40101 SET character_set_client = @saved_cs_client */;
